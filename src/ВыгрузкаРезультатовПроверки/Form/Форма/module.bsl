...
Процедура ПриОткрытии()
	...
	// TEST
	ФорматЭкспорта = ФорматЭкспортаGenericIssue;
	КаталогПроекта = "F:\DATA\Develop\Sonar\project\acc\";
	Конфигурация = Справочники.Конфигурации.ПолучитьСсылку(Новый УникальныйИдентификатор("3c713ffa-25b4-11e9-87e4-00a0c6000000"));
