...
Функция ПредставлениеОшибки(Знач ВыборкаОшибокАПК)
	...
	Представление = "";
	Если НРег(ФорматПредставленияОшибки) = НРег(ФорматОшибкиТолькоНаименование) Тогда
		Представление = ВыборкаОшибокАПК.Правило;
	ИначеЕсли НРег(ФорматПредставленияОшибки) = НРег(ФорматОшибкиКодНаименование) Тогда
